...
const aboutData = {
  ...
  professional: {
    topics: [
      ...
      { name: "Creative Digital Design", img: "creativeDesign.png", text: "Started as a humble curious eye for detail and ended up shaping how travelers experience our sites. Now, as part of the Sales team, I design data-driven offers that feel less like sales and more like smart suggestions—bridging business goals with real user needs. It’s still the same journey, but now I get to blend creativity, insight, and a bit of UX magic" }
    ]
  },
  personal: {
    topics: [
